...
public final class ChatbufProto {
  ...
  public interface ChatMessageOrBuilder
     ...
     * <code>required .net.named_data.jndn.tests.ChatMessage.ChatMessageType type = 3 [default = CHAT];</code>
     */
    ChatbufProto.ChatMessage.ChatMessageType getType();
  ...
  public static final class ChatMessage extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 24: {
              ...
              ChatbufProto.ChatMessage.ChatMessageType value = ChatbufProto.ChatMessage.ChatMessageType.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ChatbufProto.internal_static_net_named_data_jndn_tests_ChatMessage_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ChatbufProto.internal_static_net_named_data_jndn_tests_ChatMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ChatbufProto.ChatMessage.class, ChatbufProto.ChatMessage.Builder.class);
    }
    ...
    public enum ChatMessageType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ChatbufProto.ChatMessage.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private ChatbufProto.ChatMessage.ChatMessageType type_;
    /**
     * <code>required .net.named_data.jndn.tests.ChatMessage.ChatMessageType type = 3 [default = CHAT];</code>
     */
    ...
    private void initFields() {
      to_ = "";
      from_ = "";
      type_ = ChatbufProto.ChatMessage.ChatMessageType.CHAT;
      data_ = "";
      timestamp_ = 0;
    }
    ...
    public static ChatbufProto.ChatMessage parseFrom(
    ...
    public static ChatbufProto.ChatMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ChatbufProto.ChatMessage parseFrom(
    ...
    public static ChatbufProto.ChatMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ChatbufProto.ChatMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ChatbufProto.ChatMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(ChatbufProto.ChatMessage prototype) {
    ...
    public static final class Builder extends
       ...
       implements ChatbufProto.ChatMessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ChatbufProto.internal_static_net_named_data_jndn_tests_ChatMessage_descriptor;
      }
      ...
      // Construct using ChatbufProto.ChatMessage.newBuilder()
      private Builder() {
      ...
      public ChatbufProto.ChatMessage getDefaultInstanceForType() {
        return ChatbufProto.ChatMessage.getDefaultInstance();
      }

      public ChatbufProto.ChatMessage build() {
        ChatbufProto.ChatMessage result = buildPartial();
      ...
      public ChatbufProto.ChatMessage buildPartial() {
        ChatbufProto.ChatMessage result = new ChatbufProto.ChatMessage(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ChatbufProto.ChatMessage) {
          return mergeFrom((ChatbufProto.ChatMessage)other);
        } else {
      ...
      public Builder mergeFrom(ChatbufProto.ChatMessage other) {
        if (other == ChatbufProto.ChatMessage.getDefaultInstance()) return this;
        if (other.hasTo()) {
          bitField0_ |= 0x00000001;
          to_ = other.to_;
          onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ChatbufProto.ChatMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ChatbufProto.ChatMessage) e.getUnfinishedMessage();
          throw e;
        } finally {
  ...
  bitField0_ |= 0x00000002;
      ...
      // required .net.named_data.jndn.tests.ChatMessage.ChatMessageType type = 3 [default = CHAT];
      private ChatbufProto.ChatMessage.ChatMessageType type_ = ChatbufProto.ChatMessage.ChatMessageType.CHAT;
      /**
       * <code>required .net.named_data.jndn.tests.ChatMessage.ChatMessageType type = 3 [default = CHAT];</code>
       */
      public boolean hasType() {
       ...
       * <code>required .net.named_data.jndn.tests.ChatMessage.ChatMessageType type = 3 [default = CHAT];</code>
       */
      public Builder setType(ChatbufProto.ChatMessage.ChatMessageType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000004;
